...
/* Direct Link: se dispara una sola vez por página vista (imagen, video o botón de descarga
   real, lo que se toque primero), se resetea solo al navegar a otra página.
