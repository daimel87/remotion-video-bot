...
(function(){
  ...
  document.querySelectorAll('.audio-download').forEach(function(el){
    el.addEventListener('click', function(e){
      e.preventDefault();
      var real = el.getAttribute('href');
      window.open(real, '_blank', 'noopener'); // descarga real primero, para que el navegador no la bloquee
