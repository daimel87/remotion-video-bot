...
SITE = {
    ...
    "popads_popunder": '''(function(){var y=window,a="ed535ff01c04e087bea23253eda62746",q=[["siteId",393*873-373*885+5303795],["minBid",0],["popundersPerIP","0"],["delayBetween",0],["default",false],["defaultPerDay",0],["topmostLayer","auto"]],t=["d3d3LnByZW1pdW12ZXJ0aXNpbmcuY29tL3BzcHJpdGUubWluLmNzcw==","ZDJqMDQyY2oxNDIxd2kuY2xvdWRmcm9udC5uZXQvQi9oYmFza2V0LmZ1bGwubWluLmpz"],h=-1,v,m,s=function(){clearTimeout(m);h++;if(t[h]&&!(1812731935000<(new Date).getTime()&&1<h)){v=y.document.createElement("script");v.type="text/javascript";v.async=!0;var w=y.document.getElementsByTagName("script")[0];v.src="https://"+atob(t[h]);v.crossOrigin="anonymous";v.onerror=s;v.onload=function(){clearTimeout(m);y[a.slice(0,16)+a.slice(0,16)]||s()};m=setTimeout(s,5E3);w.parentNode.insertBefore(v,w)}};if(!y[a]){try{Object.freeze(y[a]=q)}catch(e){}s()}})();''',
