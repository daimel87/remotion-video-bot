...
# Buzz-SRT anchored outro (25fps). Hits ON card.
cues=[
 (30/25,  blip(1500), 0.5, 0.5),     # S1 no es un lujo
 (150/25, impact(0.55),0.0, 0.5),    # S2 indicador (ON card)
 (300/25, whoosh(0.4),0.0, 0.35),    # S2 exit
 (360/25, pop(760),  -0.4, 0.5),     # S3 like
 (510/25, chime(950),0.0, 0.45),     # S4 suscribete (ON card)
 (668/25, chime(760),0.0, 0.42),     # S5 brand outro
]
