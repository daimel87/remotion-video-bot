...
const HEADLINE =
  "This octopus mother laid her eggs once — and she will never eat again. For the next **four years**, she guards them without ever leaving, blowing water over them to keep them oxygenated and chasing off predators, while her own body **cannibalizes itself** for energy. She doesn't hunt. She doesn't rest. The moment her eggs finally hatch, her job is done — and within days, **she dies**. Scientists call it the **longest parental care of any animal on Earth**.";

const QUOTE = "Nature really said **love you to death**. 🐙💔";
...
export const AnimalFactOctopus: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: '#000'}}>
      ...
      <OffthreadVideo
        src={staticFile('octopus-fact-test.mp4')}
        muted
        style={{
          position: 'absolute',
          inset: 0,
