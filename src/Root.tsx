...
import {CLIPS, SEGMENTS, DURATION_SEC, AUDIO_SRC, TITLE} from './generic/data.generated';
  ...
  return (
    <>
      ...
      <Composition
        ...
        defaultProps={{clips: CLIPS, segments: SEGMENTS, audioSrc: AUDIO_SRC, title: TITLE || undefined}}
        fps={30}
        width={1920}
        height={1080}
      />
