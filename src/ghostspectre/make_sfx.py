...
TOTAL = float(sys.argv[2]) if len(sys.argv) > 2 else 528.81
...
cues = [
    ...
    (11.4, "pop", G_POP, -0.3),
    (18.9, "pop", G_POP, -0.3),
    (30.0, "key", G_KEY, 0), (30.15, "key", G_KEY, 0),
    (40.3, "pop", G_POP, -0.3),
    (49.0, "pop", G_POP, 0),
    # ch1 installation (55.6)
    (55.4, "riser", G_RISER, 0), (56.5, "impact", G_IMPACT * 0.8, 0),
    (58.8, "pop", G_POP, -0.3),
    (65.4, "pop", G_POP, -0.3),
    (80.6, "pop", G_POP, -0.3),
    (86.4, "key", G_KEY, 0), (86.55, "key", G_KEY, 0),
    (97.5, "pop", G_POP, 0.3),
    (110.5, "pop", G_POP, -0.3),
    (122.9, "pop", G_POP, -0.3),
    (127.6, "pop", G_POP, 0.3), (127.7, "charge", G_CHARGE, 0),
    (134.6, "pop", G_POP, -0.3),
    (140.8, "pop", G_POP, -0.3),
    # ch2 first boot (148.2)
    (148.0, "riser", G_RISER, 0), (149.1, "impact", G_IMPACT * 0.8, 0),
    (152.1, "pop", G_POP, -0.3),
    (163.8, "pop", G_POP, -0.3),
    (170.3, "key", G_KEY, 0.3), (170.5, "key", G_KEY, 0.3),
    (174.0, "pop", G_POP, -0.3),
    (176.5, "pop", G_POP, 0.3),
    # ch3 performance (184.2)
    (184.0, "riser", G_RISER, 0), (185.1, "impact", G_IMPACT * 0.8, 0),
    (187.7, "pop", G_POP, 0.3),
    (188.0, "impact", G_IMPACT * 0.7, -0.3),  # 11 stat
    (195.3, "pop", G_POP, -0.3),
    (199.0, "impact", G_IMPACT * 0.6, -0.3),  # 1.3GB
    (205.3, "pop", G_POP, -0.3),
    # ch4 storage (215.4)
    (215.2, "riser", G_RISER, 0), (216.3, "impact", G_IMPACT * 0.8, 0),
    (222.1, "impact", G_IMPACT * 0.6, -0.3),  # ISO 5.57
    (233.3, "impact", G_IMPACT * 0.6, -0.3),  # disk 8.18
    (249.1, "success", G_CHIME * 0.75, 0),    # no bloat
    (260.3, "pop", G_POP, -0.3),
    (279.8, "pop", G_POP, -0.3),
    (296.7, "pop", G_POP * 0.9, -0.3),        # no defender (caution)
    (304.3, "impact", G_IMPACT * 0.65, -0.3), # 2077
    (315.8, "pop", G_POP, -0.3),
    # ch5 ghost mode (320.4)
    (320.2, "riser", G_RISER, 0), (321.3, "impact", G_IMPACT * 0.8, 0),
    (323.9, "pop", G_POP, 0.3),
    (326.5, "pop", G_POP, 0.3),
    # ch6 ghost toolbox (348)
    (347.8, "riser", G_RISER, 0), (348.9, "impact", G_IMPACT * 0.8, 0),
    (353.0, "pop", G_POP, -0.3),
    (366.7, "key", G_KEY, 0), (366.85, "key", G_KEY, 0),
    (371.3, "pop", G_POP, -0.3),
    (398.6, "success", G_CHIME * 0.7, 0),     # store works
    # ch7 browser & test (403.7)
    (403.5, "riser", G_RISER, 0), (404.6, "impact", G_IMPACT * 0.8, 0),
    (410.8, "pop", G_POP, -0.3),
    (415.6, "pop", G_POP, -0.3),
    (428.5, "key", G_KEY, 0), (428.65, "key", G_KEY, 0),
    (438.1, "pop", G_POP, -0.3),
    (458.0, "impact", G_IMPACT * 0.7, -0.3),  # 12 stat
    (463.0, "impact", G_IMPACT * 0.7, -0.3),  # 17% stat
    # outro
    (476.6, "impact", G_IMPACT, 0), (476.7, "chime", G_CHIME, 0),
    (484.6, "pop", G_POP, -0.3),
    (494.6, "pop", G_POP, -0.3),
    # end card (501)
    (500.8, "riser", G_RISER, 0),
    (501.9, "impact", G_IMPACT * 0.8, 0),
    (502.0, "chime", G_CHIME, 0),
]
...
for t, kind, gain, pan in cues:
    sig = charge(6.3) if kind == "charge" else FACTORY[kind]()
