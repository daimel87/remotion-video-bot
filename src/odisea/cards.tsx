// Componentes de tarjeta/lower-third "premium" para el pipeline de
// Odisea. Vienen del laboratorio de variantes (src/cardlab/, ya borrado)
// -- se probaron 5 direcciones y se descarto solo "museum placard", el
// resto quedó aprobado tal cual.
import React from 'react';
import {AbsoluteFill, interpolate, spring, useCurrentFrame, useVideoConfig} from 'remotion';
import {theme} from '../theme';
import {KenBurns, Grade, Vignette, Grain} from './components';

const fade = (frame: number, from: number, to: number, fps: number, cfg = theme.spring.smooth) =>
  spring({frame: frame - from, fps, config: cfg});

// ---------------------------------------------------------------------
// EDITORIAL MINIMAL -- mucho espacio en blanco, peso liviano, nada de
// grid ni numero fantasma. Para cards de capitulo/apertura a negro.
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
// CINEMATIC TITLE -- titular enorme centrado sobre la imagen (estilo
// caratula de documental de streaming). Para la apertura del bloque.
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
// BROADCAST LOWER THIRD -- barra clasica abajo-izquierda, franja
// dorada de canto, sobre la imagen. Para presentar nombre/rol.
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
// GLASS TAG -- pastilla pequeña vidrio esmerilado, para datos rapidos
