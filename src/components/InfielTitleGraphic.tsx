...
export const InfielTitleGraphic: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{opacity: exit}}>
      ...
      <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 24 * scale}}>
        ...
        >
          Lo que{' '}
          <span style={{color: '#ff3c3c', textShadow: '0 0 30px rgba(255,60,60,0.8)'}}>TODA mujer infiel</span>
          {' '}hace al llegar a casa
        </div>
        ...
        >
          7 comportamientos que revelan la verdad
        </div>
