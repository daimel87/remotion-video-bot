...
export const TriangulacionTitleGraphic: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{opacity: exit}}>
      ...
      <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 24 * scale}}>
        ...
        >
          <span style={{color: '#ff3c3c', textShadow: '0 0 30px rgba(255,60,60,0.8)'}}>Triangulación</span>
          {' '}Emocional
        </div>
        ...
        >
          Cuando ceder destruye tu poder
        </div>
