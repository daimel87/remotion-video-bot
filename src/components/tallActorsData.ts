...
export const TALL_ACTORS: TallActor[] = [
  { name: 'Danny DeVito', heightInches: 59, photo: '', flag: '🇺🇸', country: 'United States', age: 80 },
  { name: 'Kevin Hart', heightInches: 62, photo: '', flag: '🇺🇸', country: 'United States', age: 45 },
  { name: 'Tom Cruise', heightInches: 67, photo: 'tom_cruise.webp', flag: '🇺🇸', country: 'United States', age: 62 },
  { name: 'Robert Downey Jr.', heightInches: 69, photo: '', flag: '🇺🇸', country: 'United States', age: 60 },
  { name: 'Tom Holland', heightInches: 68, photo: '', flag: '🇬🇧', country: 'United Kingdom', age: 28 },
  { name: 'Zac Efron', heightInches: 68, photo: '', flag: '🇺🇸', country: 'United States', age: 37 },
  ...
  { name: 'Brad Pitt', heightInches: 71, photo: '', flag: '🇺🇸', country: 'United States', age: 61 },
  ...
  { name: 'Chris Hemsworth', heightInches: 75, photo: '', flag: '🇦🇺', country: 'Australia', age: 41 },
  ...
  { name: 'Jason Momoa', heightInches: 76, photo: '', flag: '🇺🇸', country: 'United States', age: 45 },
  { name: 'Chris Evans', heightInches: 72, photo: '', flag: '🇺🇸', country: 'United States', age: 43 },
  { name: 'Leonardo DiCaprio', heightInches: 72, photo: '', flag: '🇺🇸', country: 'United States', age: 50 },
  { name: 'Adam Sandler', heightInches: 70, photo: 'adam_sandler.jpg', flag: '🇺🇸', country: 'United States', age: 58 },
  { name: 'Liam Neeson', heightInches: 76, photo: '', flag: '🇮🇪', country: 'Ireland', age: 72 },
];
