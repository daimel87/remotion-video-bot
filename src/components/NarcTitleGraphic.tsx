...
export const NarcTitleGraphic: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{opacity: exit}}>
      ...
      <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 24 * scale}}>
        ...
        >
          Así te{' '}
          <span style={{color: '#ff3c3c', textShadow: '0 0 30px rgba(255,60,60,0.8)'}}>manipula</span>
        ...
        >
          8 trampas emocionales que nadie te enseñó a ver
        </div>
