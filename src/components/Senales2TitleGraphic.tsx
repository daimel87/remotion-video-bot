...
export const Senales2TitleGraphic: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{opacity: exit}}>
      ...
      <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 24 * scale}}>
        ...
        >
          5 señales de que ella{' '}
          <span style={{color: '#ff3c3c', textShadow: '0 0 30px rgba(255,60,60,0.8)'}}>ya no siente nada</span>
          {' '}por ti
        </div>
        ...
        >
          La verdad que nadie se atreve a decirte
        </div>
