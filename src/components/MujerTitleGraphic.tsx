...
export const MujerTitleGraphic: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{opacity: exit}}>
      ...
      <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 24 * scale}}>
        ...
        >
          Por qué una mujer{' '}
          <span style={{color: '#ff3c3c', textShadow: '0 0 30px rgba(255,60,60,0.8)'}}>inteligente</span>
        ...
        >
          7 señales que la delatan sin que lo sepa
        </div>
