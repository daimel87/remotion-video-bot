...
export const MujerCierreGraphic: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{opacity: exit}}>
      ...
      <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 30 * scale}}>
        ...
        >
          ¿Cuántas de estas{' '}
          <span style={{color: '#ff3c3c', textShadow: '0 0 30px rgba(255,60,60,0.8)'}}>señales</span>
          {' '}reconoces en ella?
        </div>

        <div style={{display: 'flex', flexDirection: 'column', gap: 6 * scale, marginTop: 20 * scale}}>
          <div style={lineStyle(line1Enter, '#4ade80')}>
            1-2: Le interesas más de lo que crees
          </div>
          <div style={lineStyle(line2Enter, '#facc15')}>
            3-4: Está luchando contra lo que siente
          </div>
          <div style={lineStyle(line3Enter, '#ff3c3c')}>
            5 o más: Está enamorada pero muerta de miedo
          </div>
        </div>
