...
const HEADLINE =
  'This jellyfish **never dies of old age**. When it\'s injured, sick, or starving, it doesn\'t die — its cells actually **transform back into younger cells**, and its whole body **reverts into a baby** version of itself. Then it just grows up again. It\'s the **only animal on Earth** known to do this. Scientists call it **biologically immortal** and nicknamed it the **"Benjamin Button jellyfish."** It could, in theory, **repeat this cycle forever**.';

const QUOTE = "Not this jellyfish literally **pressing the reset button on death** 🪼♾️";
...
export const AnimalFactJellyfish: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: '#000'}}>
      ...
      <OffthreadVideo
        src={staticFile('jellyfish-fact.mp4')}
        muted
        style={{
          position: 'absolute',
          inset: 0,
