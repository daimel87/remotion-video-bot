  ...
  return (
    <AbsoluteFill style={{opacity: vis, background: theme.gradientDark, justifyContent: 'center', alignItems: 'center'}}>
      ...
      <div style={{textAlign: 'center', transform: `translateY(${interpolate(s1, [0, 1], [40, 0])}px)`}}>
        ...
        >
          REVIEW COMPLETA · WINDOWS 11 25H2
        </div>
        <div
          style={{
            fontFamily: FONT_TITLE,
        ...
        >
          Kernel<span style={{color: theme.red}}>OS</span>
          <br />
          PARA GAMING
        </div>
        <div
        ...
        >
          {['OPTIMIZADO PARA GAMING', 'SIN BLOAT', 'BUILD 26200'].map((t) => (
            <span
              key={t}
              style={{
                fontFamily: FONT_TITLE,
...
export const EndCard: React.FC<{durationInFrames: number}> = ({durationInFrames}) => {
  ...
  const steps = ['Windows 11 25H2 · Build 26200.7462', '13.6 GB instalado', '19 procesos · 1.2 GB RAM en reposo', 'Optimizado para gaming'];
  return (
    <AbsoluteFill style={{opacity: vis, background: theme.gradientDark, justifyContent: 'center', alignItems: 'center'}}>
      <AbsoluteFill style={{overflow: 'hidden'}}>
        <div
      ...
      <div style={{textAlign: 'center', transform: `translateY(${interpolate(s, [0, 1], [40, 0])}px)`}}>
        ...
        <div style={{fontFamily: FONT_TITLE, fontWeight: 900, fontSize: 92, color: theme.text}}>
          Kernel<span style={{color: theme.green}}>OS</span> 11 25H2
        </div>
        ...
        >
          ...
          <span style={{fontFamily: FONT_TITLE, fontWeight: 800, fontSize: 30, color: '#fff'}}>
            Enlace de descarga en el primer comentario fijado · Suscríbete
          </span>
        </div>
      </div>
    </AbsoluteFill>
...
export const Watermark: React.FC = () => {
  return (
    ...
    >
      ...
      >
        Kernel<span style={{color: theme.red}}>OS</span>11
      </span>
    </div>
  );
};
