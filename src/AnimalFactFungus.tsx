...
const HEADLINE =
  "This ant is walking around with a **fungus growing inside its brain** — and it's not even in control anymore. The fungus hijacks its nervous system, forces it to climb to the **perfect height and humidity**, then makes it clamp its jaws onto a leaf in a **death grip** it can never release. Days later, a stalk **bursts out of its head** and rains spores on the colony below. Scientists call it **'zombie ant fungus'** — and it's been doing this for **48 million years**.";

const QUOTE = "Bro this is literally **The Last of Us** but real. 🍄🐜";
...
export const AnimalFactFungus: React.FC = () => {
