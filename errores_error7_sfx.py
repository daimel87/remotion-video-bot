...
SR=44100; DUR=64.4; N=int(SR*DUR)
...
cues=[
 ...
 (100/25, blip(1500), 0.5, 0.5),     # S2 estetico
 (215/25, blip(1300),-0.4, 0.5),     # S3 visceral
 (290/25, impact(0.6),0.0, 0.55),    # S4 estrogeno (ON card)
 (440/25, whoosh(0.4),0.0, 0.35),    # S4 exit
 (490/25, blip(1300),0.4, 0.5),      # S5 +grasa
 (680/25, pop(640),  -0.4, 0.5),     # S6 insulina
 (880/25, impact(0.55),0.0, 0.5),    # S7 8-10kg (ON card)
 (1050/25,whoosh(0.4),0.0, 0.35),    # S7 exit
 (1060/25,blip(1300),0.4, 0.5),      # S8 sin medic
 (1125/25,blip(1300),-0.4, 0.5),     # S9 cintura
 (1290/25,impact(0.6),0.0, 0.55),    # S10 error 8 (ON card)
]
