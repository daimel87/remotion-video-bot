...
SR=44100; DUR=61.44; N=int(SR*DUR)
...
cues=[
 ...
 (100/25, blip(1500), 0.5, 0.5),     # S2 milagrosas
 (250/25, blip(1300),-0.4, 0.5),     # S3 aceites
 (345/25, impact(0.6),0.0, 0.55),    # S4 anillos (ON card)
 (470/25, whoosh(0.4),0.0, 0.35),    # S4 exit
 (490/25, blip(1300),0.4, 0.5),      # S5 urgencias
 (620/25, impact(0.6),0.0, 0.55),    # S6 emergencia (ON card)
 (745/25, whoosh(0.4),0.0, 0.35),    # S6 exit
 (760/25, pop(640),  -0.4, 0.5),     # S7 delicado
 (920/25, blip(1300),0.4, 0.5),      # S8 cicatrices
 (1115/25,blip(1300),-0.4, 0.5),     # S9 medico
 (1270/25,impact(0.6),0.0, 0.55),    # S10 error 9 (ON card)
]
