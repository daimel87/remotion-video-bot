...
SR=44100; DUR=66.44; N=int(SR*DUR)
...
cues=[
 ...
 (110/25, blip(1500), 0.5, 0.5),     # S2 subestimado
 (280/25, impact(0.6),0.0, 0.55),    # S3 cortisol (ON card)
 (430/25, whoosh(0.4),0.0, 0.35),    # S3 exit
 (470/25, pop(640),  -0.4, 0.5),     # S4 pelea o huye
 (610/25, impact(0.6),0.0, 0.55),    # S5 sobrevivir (ON card)
 (785/25, whoosh(0.4),0.0, 0.35),    # S5 exit
 (800/25, blip(1300),0.4, 0.5),      # S6 sanos
 (975/25, blip(1300),-0.4, 0.5),     # S7 resolver
 (1120/25,blip(1300),0.4, 0.5),      # S8 arterias
 (1275/25,impact(0.6),0.0, 0.55),    # S9 error 10 (ON card)
]
