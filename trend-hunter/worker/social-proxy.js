// Cloudflare Worker: proxy propio para leer Reddit, Google Trends y Google
// News desde el navegador sin chocar con CORS. Es la forma CONFIABLE de
// hacerlo — los proxies CORS públicos genéricos (allorigins.win,
// corsproxy.io, etc.) suelen estar bloqueados por ad-blockers y extensiones
// de privacidad (uBlock, Brave Shields...) porque están en listas de
// bloqueo por ser "proxies de evasión". Este Worker es tuyo, con tu propio
// dominio, así que no cae en esas listas.
//
